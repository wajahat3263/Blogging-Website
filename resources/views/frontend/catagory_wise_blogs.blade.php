...
@section('title')
    Blog Catagory - Personal Portfolio
@endsection
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-8 col-md-10">
                        <div class="breadcrumb__wrap__content">
                            <h2 class="title">{{ $cat_name->blog_catagory }}</h2>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="standard__blog__post">
                            <div class="standard__blog__thumb">
                                <a href="#"><img src="{{ asset($blog_post->blog_image) }}" alt=""></a>
                            ...
                            <div class="standard__blog__content">
                                ...
                                <h2 class="title"><a href="{{ route('blog.details',$blog_post->id) }}">{{ $blog_post->blog_title }}</a></h2>
                                <!-- @php
                                $a = Str::limit($blog_post->blog_description, 200);
                                @endphp -->
                                <p>{!! Str::limit($blog_post->blog_description, 200) !!}</p>
                                <ul class="blog__post__meta">
                                    <li><i class="fal fa-calendar-alt"></i> {{ Carbon\Carbon::parse($blog_post->created_at)->diffForHumans() }}</li>
                                </ul>
                            </div>
                        </div>
