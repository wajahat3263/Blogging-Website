...
@section('title')
    Blog Details - Personal Portfolio
@endsection
                ...
                <div class="col-lg-8">
                    <div class="standard__blog__post">
                        <div class="standard__blog__thumb">
                            <img src="{{ asset($details->blog_image) }}" alt="">
                        </div>
                        ...
                        <div class="blog__details__bottom">
                            <ul class="blog__details__tag">
                                ...
                                <li class="tags-list">
                                    @php
                                        $tags = explode(',', $details->blog_tags);
                                    @endphp
                            ...
                            <ul class="rc__post">
                                ...
                                <li class="rc__post__item">
                                    ...
                                    <div class="rc__post__content">
                                        ...
                                        <span class="post-date"><i class="fal fa-calendar-alt"></i> {{ Carbon\Carbon::parse($details->created_at)->diffForHumans() }}</span>
                                    </div>
                                </li>
