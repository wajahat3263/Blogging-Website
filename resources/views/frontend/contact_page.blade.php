        ...
        <form method="POST" action="{{ route('store.message') }}" class="contact__form">
            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    <input class="mb-0" type="text" name="name" placeholder="Enter your name*">
                ...
                <div class="col-md-6 mb-4">
                    <input class="mb-0" type="email" name="email" placeholder="Enter your mail*">
                    <div class="text-start">
                        @error('email')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                ...
                <div class="col-md-6 mb-4">
                    <input class="mb-0" type="text" name="subject" placeholder="Enter your subject*">
                    <div class="text-start">
                        @error('subject')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                ...
                <div class="col-md-6 mb-4">
                    <input class="mb-0" type="text" name="phone" placeholder="Your phone*">
                    <div class="text-start">
                        @error('phone')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                ...
                <div class="col-md-12 mb-5">
                    <textarea class="mb-0" name="message" id="message" placeholder="Enter your massage*"></textarea>
                    <div class="text-start">
                        @error('message')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
